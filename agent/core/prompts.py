...
- Prefer detect_project early when repo type is unclear.
- Prefer run_validation over ad-hoc test/lint commands when you want to validate Python, Node, Go, or Rust repos.
